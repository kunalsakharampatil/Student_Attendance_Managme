...
<div class="container  "><div class="row" >
			<div class="col-md-6 offset-md-3  " >
						...
						<p class="fs-3 text-center kp2 d">Subject_Details</p>
						

						<table class="table kp2">
							<thead>
								<tr>
...
while(rs.next())
{
	...
	out.println("<td><a href=subjecdelet.jsp?id="+rs.getInt(1)+" ><h5 type='submit' class='btn btn-danger'>Delete</h5></a></td>");
