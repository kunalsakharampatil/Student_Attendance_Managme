...
<div class="container">
		<div class="col-md-10 offset-md-1 " >
							<p class="fs-3 text-center k d">Teacher_Details</p>
...
while(rs.next())
{
	...
	out.println("<td><a href=teacherdelet.jsp?id="+rs.getInt(1)+" ><h5 type='submit' class='btn btn-danger'>Delete</h5></a></td>");
